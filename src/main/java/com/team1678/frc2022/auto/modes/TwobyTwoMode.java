...
public class TwobyTwoMode extends AutoModeBase {
   ...
   String file_path_a = "paths/TwoBallPaths/TwobyTwo A.path";
   String file_path_b = "paths/TwoBallPaths/TwobyTwo B.path";
   String file_path_c = "paths/TwoBallPaths/TwobyTwo C.path";
   ...
   @Override
    ...
    runAction(new LambdaAction(() -> mSwerve.resetOdometry(new Pose2d(driveToIntakeFirstCargo.getInitialPose().getX(),
    driveToIntakeFirstCargo.getInitialPose().getY(),
    Rotation2d.fromDegrees(320)))));
