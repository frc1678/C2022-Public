...
public class AutoModeSelector {
    ...
    public AutoModeSelector() {
        ...
        mModeChooser.addOption("Five Ball + 1 Mode", DesiredMode.FIVE_BALL_PLUS_1_AUTO);
        mModeChooser.addOption("Five Ball A Mode", DesiredMode.FIVE_BALL_A_AUTO);
